...
//attach servo
  servo.attach(9);
  //Need to establish original servo position
  //int servoOrigin= servo.read();
  //servoOrigin=0;
}
ISR(PCINT1_vect) {
...
static int Rotarypos = 0;
  ...
  if (Serial.available() > 0) {
    ...
    desiredTail = Serial.read();

    //Serial.print("Desired tail angle");
    //Serial.println(desiredTail, DEC);
        
    servo.write(tailAngle);
  }
}
