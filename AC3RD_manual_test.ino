...
//  compass.enableDefault();
  ...
  //Data header///
  String dataHeader = "GyroX,GyroY,GyroZ,CompassAX,CompassAY,CompassAZ,CompassMX,CompassMY,CompassMZ,Pot1Angle,Pot2Angle,LatDeg,LongDeg,Velocity,fixQuality,windspeedMPH,tailAngle,rudderAngle,autoSwitch";
...
//    WindSpeed_MPH =  pow(((RV_Wind_Volts - zeroWind_volts) /.2300) , 2.7265); 
    ...
    if (controlComplete) {
      ...
      autoSwitch = button.toInt();
      
      ///Use boolean to set control scheme to parse manual inputs or automatic calculatons
